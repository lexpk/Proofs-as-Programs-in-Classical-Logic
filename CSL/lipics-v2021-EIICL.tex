...
\todo{find better name for section, as the normalization works for equisatsifiability as well as for equivalidity}
...
\todo{can you add a few sentences on proof translations, which is an important goal because it allows program extraction using the curry-howard correspondence?}
