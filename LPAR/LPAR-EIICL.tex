...
\begin{definition}
	...
	\end{itemize}
	 Here $a$ is a free variable that does not occur in $\varphi$. $\varphi$ is satisfiable if $\mathcal M, v\models\varphi$ for some $\mathcal M, v$. It is valid if $\mathcal M, v\models\varphi$ for every $\mathcal M, v$. We denote the set of valid formulae with \emph{CQC} (Classical Quantified Calculus).
\end{definition}
