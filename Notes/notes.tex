...
\small{
	...
	\RightLabel{\scriptsize subst}
	\BinaryInfC{$\vdash \beta(y)(\gamma(y))_\delta : Q(x, y)$}
	\RightLabel{\scriptsize $\supset\hspace{-2pt}I^u$}
	\UnaryInfC{$\delta : f(y)=x\vdash\beta(y)(\gamma(y))_\delta : Q(x, y)$}
	\RightLabel{\scriptsize$\exists I$}
	\UnaryInfC{$\delta : f(y)=x\vdash \langle y, \beta(y)(\gamma(y))_\delta\rangle :\Sigma_y Q(x, y)$}
	\RightLabel{\scriptsize $\exists E$}
	\BinaryInfC{$\vdash \textbf{let }\langle y, \delta\rangle = \alpha(x)\textbf{ in }\langle y,\beta(y)(\gamma(y)\delta)\rangle: \Sigma_y Q(x, y)$}
	\RightLabel{\scriptsize $\forall I$}
	\UnaryInfC{$\lambda x.\textbf{let }\langle y, \delta\rangle = \alpha(x)\textbf{ in }\langle y,\beta(y)(\gamma(y))_\delta\rangle:\Pi_x \Sigma_y Q(x, y)$}
