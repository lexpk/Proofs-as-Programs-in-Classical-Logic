...
\usepackage{footmisc}
\usepackage{wrapfig}
\usepackage[a4paper,top=2.5cm,bottom=3.5cm,left=2.5cm,right=2.5cm,headsep=10pt]{geometry}
...
\begin{document}
	...
	\begin{center}
		...
		\Large\textbf{Alexander Pluska, B.Sc.} % Insert your name in this line
		\vskip15mm
	...
	\begin{flushleft}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{p{7cm} p{10cm}}
				...
				Betreut von / Supervisor: & Univ.-Prof. Matthias Aschenbrenner \\ % Insert your program/supervisor here
	...
	\begin{example}
		...
		\begin{center}
			\AxiomC{}
			\RightLabel{Ax}
			\UnaryInfC{$\substack{A^\#(g(s)),\\\forall u(\forall x(A^\#(g(u))\to B^\#(g(u)))\to B^\#(u))}
				\Rightarrow B^\#(s), A^\#(f(s))$}
			\RightLabel{R$\to$}
